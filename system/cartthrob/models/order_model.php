...
class Order_model extends CI_Model
{
	...
	public function update_order_items($entry_id, $data)
	{
		...
		$default_keys = array('entry_id', 'title', 'quantity', 'price', 'price_plus_tax', 'weight', 'shipping', 'no_tax', 'no_shipping');
	...
	protected function update_product_inventory($row, $original_row, $new_item = FALSE)
	{
		...
		$default_keys = array('row_id', 'row_order', 'order_id', 'entry_id', 'title', 'quantity', 'price', 'price_plus_tax', 'weight', 'shipping', 'no_tax', 'no_shipping');
